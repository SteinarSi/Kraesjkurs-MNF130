...
\begin{frame}{$\lnot$ og sannhetstabeller}
    \begin{itemize}
        \item Gitt en proposisjon $p$, kan vi bruke \emph{operatorer} for å få \emph{sammensatte} proposisjoner
        \item Vi representerer den motsatte proposisjonen av $p$ som $\lnot p$.
