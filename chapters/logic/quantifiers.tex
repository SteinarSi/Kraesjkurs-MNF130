...
Det viser seg at De Morgan's lover også fungerer på kvantorer.\\
    ...
    \begin{itemize}
        ...
        $\equiv \lnot [P(x_1) \land P(x_2) \land \ldots \land P(x_n)]$\\
        $\equiv \lnot P(x_1) \lor \lnot P(x_2) \lor \ldots \lor \lnot P(x_n)$\\ $\equiv \exists x : \lnot P(x)$
        \pause
        \item $\lnot \exists x : P(x)$\\
        $\equiv \lnot [P(x_1) \lor P(x_2) \lor \ldots \lor P(x_n)]$\\
        $\equiv \lnot P(x_1) \land \lnot P(x_2) \land \ldots \land \lnot P(x_n)$\\ 
