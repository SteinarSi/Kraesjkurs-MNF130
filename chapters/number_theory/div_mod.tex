...
\begin{frame}{Modulo ved divisjon}
    ...
    $[3/6]_8$?\\
    \pause
    Nei, noen ganger fungerer det, noen ganger ikke. \\
    I modulær aritmetikk tolkes $[a/b]_n$ som $[a \cdot b^{-1}]_n$,\\
    hvor $b^{-1}$ er den modulære inversen av $b$. Denne finnes bare om $gcd(b,n)=1$ (Forklares senere)

    Vi kan altså ikke alltid dele!
\end{frame}